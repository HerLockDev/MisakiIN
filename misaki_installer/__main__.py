...
def createApp (connect):
    appname = "misaki" + str(time() * 1000)[-4:].replace(".", "") + str(random.randint(0,500))
    try:
...
if __name__ == "__main__":
    ...
    onemli("(i) MisakiUserBot indiriliyor...")

    if os.path.isdir("./thoruserbot/"):
        del_it('./thoruserbot/')
    repo = Repo.clone_from("https://github.com/HerLockDev/MisakiBOT", "./misakibot/", branch="main")
    basarili("(✓) MisakiUserBot indirildi!")
    ...
    config['SESSION_ADI'] = 'TexeraUserBot'
